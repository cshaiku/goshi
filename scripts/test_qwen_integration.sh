...
(sleep 0.5; echo "hello, what are you?"; sleep 20; echo "q") | ./bin/goshi --headless 2>&1 | head -60
...
(sleep 0.5; echo "List the files in this folder."; sleep 20; echo "q") | ./bin/goshi --headless 2>&1 | head -60
